  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <img src={wavyvoLogo} alt="Wayvo AI" style={{ height: 32, width: 32, objectFit: 'contain' }} />
        <span className={`font-bold text-base ${darkMode ? 'text-white' : 'text-gray-900'}`}>Wayvo AI</span>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${darkMode ? 'text-gray-300 hover:bg-gray-700 border-gray-600' : 'text-gray-700 hover:bg-gray-50 border-gray-200'}`}
